// Adapted from ghostty v1.3.1: macos/Sources/Ghostty/GhosttyPackage.swift
import os
import SwiftUI
import GhosttyKit
...
// Flight Deck: dropped `extension Ghostty.SplitFocusDirection.toSplitTreeFocusDirection`
// (referenced app-shell `SplitTree`; splits are out of scope for the single-surface skeleton).
