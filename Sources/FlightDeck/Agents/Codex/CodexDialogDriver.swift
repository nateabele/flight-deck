...
///   (`TextInjecting:153`), built over `GHOSTTY_POINT_ACTIVE` (formerly `_VIEWPORT`, which
///   tracked scroll position and could go stale on a surface not scrolled to the tail — see
///   `cachedVisibleContents`'s doc comment). Two caches, two selections.
