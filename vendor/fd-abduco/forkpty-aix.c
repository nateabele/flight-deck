/*
 * Vendored from martanne/abduco @ e76729a2df45ecabe72a423e925ed876f66235d6 (tag v0.6): forkpty-aix.c
 * Flight Deck fork ("fd-abduco") -- see vendor/fd-abduco/PROVENANCE.md.
 * Not built by scripts/build-fd-abduco.sh (AIX-only; guarded by #if defined(_AIX) in abduco.c);
 * kept for source fidelity with upstream.
 *
